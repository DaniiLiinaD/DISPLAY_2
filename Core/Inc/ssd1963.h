...
#include "main.h" //HAL functions defenition 


/****************Settings********************/

/********************************************/
/*   FMC address, depends on BANK number    */
/********************************************/
#define SSD1963_DATA_ADR     0x60020000 // FMC address pin A16
#define SSD1963_COMMAND_ADR  0x60000000

/********************************************/
/*       RESET PIN GPIO  define             */
/********************************************/
#define SSD1963_RESET_GPIO_Port DISP_RESET_GPIO_Port
#define SSD1963_RESET_Pin       DISP_RESET_Pin
